...
<div style="width: 100%;height: 100px;text-align: center">
    ...
    <span style="font-size: 1.2em;">&lceil;演出信息&rfloor;-&lceil;我的关注&rfloor;进行查看</span>
</div>
...
<div class="tishi" onclick="$('.tishi').css('display','none')" style="width: 100%;height: 100%;opacity: 0.7;position:absolute;top: 0;display: none">
    <img width="99%" height="100%" src="/wx_shool/Public/Home/images/ex1.png" alt=""/>
</div>
</body>
    ...
    wx.ready(function () {
        ...
        document.querySelector('#onMenuShareTimeline').onclick = function (){
            ...
            wx.onMenuShareTimeline({
                title: '演出分享',
                link: 'http://zxcasdmko.gotoip3.com/wx_shool/index.php/home/activity/activitydetail1/activityId/'+<?php echo ($activityId); ?>,
                imgUrl: '',
